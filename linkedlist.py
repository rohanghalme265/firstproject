...
*This creates a loop, so you can keep traversing indefinitely.

#why we use Circular linked list? 
       
       i). Endless traversal — you can keep going around without restarting.
      ii). Efficient for certain problems — like implementing a round-robin scheduler, circular queues, or music playlists that loop.
      iii). Quick insertion/deletion at both ends without needing to traverse from start each time.
'''
